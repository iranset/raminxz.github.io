                    ...
                    if (v.State.calls[o]) {
                        ...
                        for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                            ...
                            if (a(C)) {
                                ...
                                for (var M in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility),
                                k)
                                    if ("element" !== M) {
                                        var T, I = k[M], A = p.isString(I.easing) ? v.Easings[I.easing] : I.easing;
                                        if (1 === g)
                                            T = I.endValue;
                                        else {
                                            var P = I.endValue - I.startValue;
                                            if (T = I.startValue + P * A(g, d, P),
                                            !f && T === I.currentValue)
                                                continue
                                        }
                                        if (I.currentValue = T,
            ...
            var x = function() {
                ...
                function r() {
                    function t(t) {
                        ...
                        if ("scroll" === T) {
                            var x, k, M, A = /^x$/i.test(c.axis) ? "Left" : "Top", P = parseFloat(c.offset) || 0;
                            c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container,
                            M = (x = c.container["scroll" + A]) + u(r).position()[A.toLowerCase()] + P) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]],
                            ...
                            y) {
                                ...
                                if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                                    ...
                                    c._cacheValues && O && O[E] ? (V === n && (V = O[E].endValue + O[E].unitType),
                                    z = a(r).rootPropertyValueCache[N]) : b.Hooks.registered[E] ? V === n ? (z = b.getPropertyValue(r, N),
                                    V = b.getPropertyValue(r, E, z)) : z = b.Hooks.templates[N][1] : V === n && (V = b.getPropertyValue(r, E));
                                    var H, B, j, Y = !1;
                                    if (V = (H = f(E, V))[0],
                                    j = H[1],
                                    ...
                                    V = parseFloat(V) || 0,
                                    $ = parseFloat($) || 0,
                                    "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? ($ /= 100,
                                    B = "em") : /^scale/.test(E) ? ($ /= 100,
                                    B = "") : /(Red|Green|Blue)$/i.test(E) && ($ = $ / 100 * 255,
                                    B = "")),
                                    /[\/*]/.test(Y))
                                        B = j;
                                    else if (j !== B && 0 !== V)
                        ...
                        a(r).opts = c),
                        a(r).isAnimating = !0,
                        S === C - 1 ? (v.State.calls.push([F, g, c, null, I.resolver]),
                ...
                g = o(g)) {
                    ...
                    if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(w)) {
                        ...
                        for (var M = f + 1; M < arguments.length; M++)
                            p.isArray(arguments[M]) || !/^(fast|normal|slow)$/i.test(arguments[M]) && !/^\d/.test(arguments[M]) ? p.isString(arguments[M]) || p.isArray(arguments[M]) ? w.easing = arguments[M] : p.isFunction(arguments[M]) && (w.complete = arguments[M]) : w.duration = arguments[M]
                    }
                    var T, I = {
                        promise: null,
                        resolver: null,
                        ...
                        if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                            if (p.isString(y) && v.Redirects[y]) {
                                ...
                                u.each(g, function(t, e) {
                                    ...
                                    E.duration = Math.max(E.duration * (E.backwards ? 1 - t / C : (t + 1) / C), .75 * E.duration, 200)),
                                    v.Redirects[y].call(e, e, E || {}, t, C, g, I.promise ? I : n)
                                }),
                                t()
                            }
    ...
    return function() {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    getPointRotation: function(t, e) {
                        var i = this.chart.options.elements.point.rotation
                          , n = this.getDataset()
                          , o = t.custom || {};
                        return isNaN(o.rotation) ? isNaN(n.pointRotation) && !a.isArray(n.pointRotation) || (i = a.valueAtIndexOrDefault(n.pointRotation, e, i)) : i = o.rotation,
                        i
                    },
                    updateElement: function(t, e, i) {
                    ...
                    draw: function() {
                        ...
                        for (e(this.getDataset(), i.options) && (t = (n.dataset._model.borderWidth || 0) / 2,
                        ...
                        n.dataset.draw(),
                        a.canvas.unclipArea(i.ctx)); l < s; ++l)
                            o[l].draw(r)
                    },
                    setHoverStyle: function(t) {
        ...
        19: [function(t, e, i) {
            ...
            e.exports = function(t) {
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    linkScales: a.noop,
                    update: function(t) {
                        var e, i, n, o = this, r = o.getDataset(), s = o.getMeta(), l = o.chart.options.startAngle || 0, c = o._starts = [], u = o._angles = [];
                        for (o._updateRadius(),
                        s.count = o.countVisibleElements(),
                        e = 0,
                        i = r.data.length; e < i; e++)
                            c[e] = l,
                            n = o._computeAngle(e),
                            u[e] = n,
                            l += n;
                    ...
                    _computeAngle: function(t) {
                        var e = this
                          ...
                          , n = e.getDataset()
                          , o = e.getMeta();
                        if (isNaN(n.data[t]) || o.data[t].hidden)
                            return 0;
                        var r = {
                            chart: e.chart,
                            dataIndex: t,
                ...
                r.extend(t.prototype, {
                    construct: function(e, i) {
                        ...
                        i = function(t) {
                            ...
                            e.labels = e.labels || [],
                            t.options = r.configMerge(a.global, a[t.type], t.options || {}),
                            t
                        }(i);
                    ...
                    resize: function(t) {
                        ...
                        if ((e.width !== a || e.height !== s) && (n.width = e.width = a,
                        n.height = e.height = s,
                        n.style.width = a + "px",
                        n.style.height = s + "px",
                    ...
                    buildOrUpdateScales: function() {
                        ...
                        r.each(o, function(i) {
                            ...
                            e(o.position) !== e(i.dposition) && (o.position = i.dposition),
                            a[s] = !0;
                            var c = null;
                    ...
                    update: function(e) {
                        ...
                        !1 !== u.notify(o, "beforeUpdate")) {
                            ...
                            o.updateLayout(),
                            o.options.animation && o.options.animation.duration && r.each(a, function(t) {
                                t.reset()
                            }),
                            o.updateDatasets(),
                    ...
                    updateLayout: function() {
                        !1 !== u.notify(this, "beforeLayout") && (l.update(this, this.width, this.height),
                    ...
                    updateDataset: function(t) {
                        ...
                        !1 !== u.notify(this, "beforeDatasetUpdate", [i]) && (e.controller.update(),
                    ...
                    draw: function(t) {
                        ...
                        e.transition(t),
                        e.width <= 0 || e.height <= 0 || !1 !== u.notify(e, "beforeDraw", [t]) && (r.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e),
                    ...
                    drawDataset: function(t, e) {
                        ...
                        !1 !== u.notify(this, "beforeDatasetDraw", [n]) && (i.controller.draw(e),
                    ...
                    _drawTooltip: function(t) {
                        ...
                        !1 !== u.notify(this, "beforeTooltipDraw", [i]) && (e.draw(),
                        u.notify(this, "afterTooltipDraw", [i]))
                    },
        ...
        33: [function(t, e, i) {
            ...
            e.exports = o.extend({
                ...
                fit: function() {
                    ...
                    if (e.width = p ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && l.drawTicks ? m : 0,
                    ...
                    if (o.display && h) {
                        ...
                        if (p) {
                            ...
                            0 !== t.labelRotation ? (t.paddingLeft = "bottom" === n.position ? k * S + 3 : k * b + 3,
                            t.paddingRight = "bottom" === n.position ? k * b + 3 : k * M + 3) : (t.paddingLeft = S / 2 + 3,
                    ...
                    if (i.display) {
                        ...
                        if (a.each(g, function(n, o) {
                            if (!a.isNullOrUndef(n.label)) {
                                var c, u, d, p, v, y, b, x, k, C, S, D, E, L, F = n.label;
                                o === e.zeroLineIndex && i.offset === h.offsetGridLines ? (c = h.zeroLineWidth,
                                u = h.zeroLineColor,
                                d = h.zeroLineBorderDash,
                                p = h.zeroLineBorderDashOffset) : (c = a.valueAtIndexOrDefault(h.lineWidth, o),
                                ...
                                if (m) {
                                    var V = w + W;
                                    "bottom" === i.position ? ($ = f ? "middle" : "top",
                                    R = f ? "right" : "center",
                        ...
                        a.each(T, function(t) {
                            ...
                            o.beginPath(),
                            h.drawTicks && (o.moveTo(t.tx1, t.ty1),
                            o.lineTo(t.tx2, t.ty2)),
                            h.drawOnChartArea && (o.moveTo(t.x1, t.y1),
                            o.lineTo(t.x2, t.y2)),
                            o.stroke(),
                            o.restore()),
                            s.display) {
                                ...
                                var i = t.label;
                                if (a.isArray(i))
                                    for (var n = i.length, r = 1.5 * y.size, l = e.isHorizontal() ? 0 : -r * (n - 1) / 2, c = 0; c < n; ++c)
                                        o.fillText("" + i[c], 0, l),
                                        l += r;
                                else
                                    o.fillText(i, 0, 0);
                        ...
                        if (h.drawBorder) {
                            ...
                            m ? (V = N = "top" === i.position ? e.bottom : e.top,
                            V += z,
                            N += z) : ($ = W = "left" === i.position ? e.right : e.left,
                            $ += z,
                            W += z),
                            o.beginPath(),
                            o.moveTo($, V),
        ...
        36: [function(t, e, i) {
            ...
            (e.exports = o.extend({
                ...
                update: function(t) {
                    var e, i, n, o, s, l, c, d = this, h = d._options, p = d._model, f = d._model = u(h), m = d._active, g = d._data, v = {
                        xAlign: p.xAlign,
                        yAlign: p.yAlign
                    }, y = {
                        x: p.x,
                ...
                drawTitle: function(t, e, i, n) {
                    ...
                    if (o.length) {
                        ...
                        for (i.fillStyle = s(e.titleFontColor, n),
                        i.font = a.fontString(c, e._titleFontStyle, e._titleFontFamily),
                        r = 0,
                        l = o.length; r < l; ++r)
                ...
                drawBody: function(t, e, i, n) {
                    ...
                    i.textBaseline = "top",
                    i.font = a.fontString(o, e._bodyFontStyle, e._bodyFontFamily);
                    var c = 0
                      , u = function(e) {
                        i.fillText(e, t.x + c, t.y),
                        t.y += o + r
                    };
                    i.fillStyle = s(e.bodyFontColor, n),
                    a.each(e.beforeBody, u);
                    ...
                    a.each(l, function(r, l) {
                        ...
                        a.each(r.lines, function(a) {
                            d && (i.fillStyle = s(e.legendColorBackground, n),
                ...
                drawFooter: function(t, e, i, n) {
                    var o = e.footer;
                    o.length && (t.y += e.footerMarginTop,
            ...
            e.exports = o.extend({
                ...
                draw: function(t) {
                    var e = this._view
                      ...
                      , u = e.x
                      , d = e.y;
                    e.skip || (void 0 === t || i.x >= t.left && 1.01 * t.right >= i.x && i.y >= t.top && 1.01 * t.bottom >= i.y) && (o.strokeStyle = e.borderColor || r,
                        ...
                        var t = this
                          ...
                          , a = t.ticks = function(t, e) {
                            ...
                            if (t.stepSize && t.stepSize > 0)
                                ...
                                void 0 !== (o = t.precision) && (i = Math.pow(10, o),
                                a = Math.ceil(a * i) / i)
                            }
                            var l = Math.floor(e.min / a) * a
                              , c = Math.ceil(e.max / a) * a;
                            n.isNullOrUndef(t.min) || n.isNullOrUndef(t.max) || !t.stepSize || n.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) && (l = t.min,
                            c = t.max);
                            var u = (c - l) / a;
                            u = n.almostEquals(u, Math.round(u), a / 1e3) ? Math.round(u) : Math.ceil(u),
                            o = 1,
                            a < 1 && (o = Math.pow(10, 1 - Math.floor(n.log10(a))),
                            l = Math.round(l * o) / o,
                            c = Math.round(c * o) / o),
                            r.push(void 0 !== t.min ? t.min : l);
                            for (var d = 1; d < u; ++d)
                                r.push(Math.round((l + d * a) * o) / o);
                            return r.push(void 0 !== t.max ? t.max : c),
                            r
                        }(o, t);
                ...
                var f = t.LinearScaleBase.extend({
                    ...
                    fit: function() {
                        ...
                        this.options.pointLabels.display ? function(t) {
                            var e, i, n, a = l(t), r = Math.min(t.height / 2, t.width / 2), u = {
                                r: t.width,
                                l: 0,
                                t: t.height,
                                b: 0
                                ...
                                if (l > 0 || a.reverse) {
                                    ...
                                    a.display) {
                                        ...
                                        a.showLabelBackdrop) {
                                            ...
                                            c.fillRect(-h / 2 - a.backdropPaddingX, -u - f / 2 - a.backdropPaddingY, h + 2 * a.backdropPaddingX, f + 2 * a.backdropPaddingY)
                                        }
                                        c.textAlign = "center",
            ...
            function y(t, e, i, o) {
                var r, s = o.time, l = s.unit || function(t, e, i, n) {
                    ...
                    for (o = d.indexOf(t); o < s - 1; ++o)
                        if (r = (a = u[d[o]]).steps ? a.steps[a.steps.length - 1] : c,
                        a.common && Math.ceil((i - e) / (r * a.size)) <= n)
                            return d[o];
                    return d[s - 1]
                }(s.minUnit, t, e, i), h = v(l), p = a.valueOrDefault(s.stepSize, s.unitStepSize), f = "week" === l && s.isoWeekday, m = o.ticks.major.enabled, g = u[l], y = n(t), b = n(e), x = [];
                for (p || (p = function(t, e, i, n) {
                    var o, a, r, s = e - t, l = u[i], c = l.size, d = l.steps;
                    if (!d)
                        return Math.ceil(s / (n * c));
                    for (o = 0,
                ...
                r = n(y),
                m && h && !f && !s.round && (r.startOf(h),
                r.add(~~((y - r) / (g.size * p)) * p, l)); r < b; r.add(p, l))
                    x.push(+r);
                return x.push(+r),
                x
            }
            e.exports = function() {
                var t = r.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        for (t = 0,
                        i = d.data.labels.length; t < i; ++t)
                            w.push(g(d.data.labels[t], u));
                        for (t = 0,
                        i = (d.data.datasets || []).length; t < i; ++t)
                            if (d.isDatasetVisible(t))
                                if (r = d.data.datasets[t].data,
                                a.isObject(r[0]))
                                    for (x[t] = [],
                                    e = 0,
                                    o = r.length; e < o; ++e)
                                ...
                                x[t] = [];
                        w.length && (w = p(w).sort(h),
                        v = Math.min(v, w[0]),
                        y = Math.max(y, w[w.length - 1])),
                        b.length && (b = p(b).sort(h),
                        v = Math.min(v, b[0]),
                    ...
                    buildTicks: function() {
                        ...
                        for ("ticks" === s.bounds && c.length && (a = c[0],
                        r = c[c.length - 1]),
                        a = g(l.min, o) || a,
                        r = g(l.max, o) || r,
                        t = 0,
                        ...
                        o._offsets = function(t, e, i, n, o) {
                            ...
                            r = e[0],
                            s = (f(t, "time", a, "pos") - f(t, "time", r, "pos")) / 2),
                            o.time.max || (a = e[e.length - 1],
                            r = e.length > 1 ? e[e.length - 2] : i,
                            l = (f(t, "time", a, "pos") - f(t, "time", r, "pos")) / 2)),
                            {
                                left: s,
                                right: l
                            }
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        n.tooltipFormat ? m(o, n).format(n.tooltipFormat) : "string" == typeof o ? o : m(o, n).format(this._labelFormat)
                    },
...
!function(t) {
    ...
    t(n).each(function(e, i) {
        ...
        o(n),
        i.validity.badInput && a.addClass("active")
    }),
        ...
        return function() {
            ...
            function u(i) {
                ...
                !function(t, e) {
                    ...
                    u.append(f)),
                    a.closeButton && (g.addClass("md-toast-close-button").attr("role", "button"),
                    u.prepend(g)),
                    a.progressBar && (m.addClass("md-toast-progress"),
                    u.prepend(m)),
        ...
        this.each(function() {
            ...
            n.hover) {
                ...
                i.on("mouseleave", function(e) {
                    ...
                    t(i).closest(".dropdown-content").is(a) || (a.stop(!0, !0),
                    l(),
                    c = !1)
                }),
                a.on("mouseleave", function(e) {
                    var n = e.toElement || e.relatedTarget;
                    t(n).closest(".dropdown-button").is(i) || (a.stop(!0, !0),
                    l(),
                    c = !1)
                })
            } else
                ...
                i.bind("click.".concat(i.attr("id")), function(e) {
                    ...
                    t(document).unbind("click.".concat(a.attr("id"), " touchstart.").concat(a.attr("id")))) : (e.preventDefault(),
                    s("click")),
                    a.hasClass("active") && t(document).bind("click.".concat(a.attr("id"), " touchstart.").concat(a.attr("id")), function(e) {
                        a.is(e.target) || i.is(e.target) || i.find(e.target).length || (l(),
                        t(document).unbind("click.".concat(a.attr("id"), " touchstart.").concat(a.attr("id"))))
                    }))
                });
    ...
    var e = 240
      ...
      , d = function() {
        function d(h, p) {
            ...
            this.$element = h,
            this.$elementCloned = h.clone().css({
        ...
        return _createClass(d, [{
            ...
            value: function() {
                ...
                this.$dragTarget.on("touchstart", function(e) {
                    t.lastTouchVelocity.x.startPosition = e.touches[0].clientX,
            ...
            value: function(t) {
                if ("touchmove" === t.type) {
                    var e = t.touches[0]
                      , i = e.clientX;
                    Date.now() - this.lastTouchVelocity.x.startTime > 20 && (this.lastTouchVelocity.x.startPosition = e.clientX,
            ...
            value: function(t) {
                if ("left" === this.options.edge) {
                    ...
                    this.menuOut = e,
                    this.$menu.css("transform", "translateX(".concat(t - this.options.MENU_WIDTH, "px)"))
                } else {
            ...
            value: function() {
                var e = this;
                !0 === this.options.showOverlay && (this.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'),
            ...
            value: function(t) {
                if ("touchend" === t.type) {
                    ...
                    o > 0 && (o = 0),
                    a < 0 && (a = 0),
                    "left" === this.options.edge ? (this.menuOut && i <= .3 || i < -.5 ? (0 !== o && this.translateMenuX([0, o], "300"),
                    this.showSidenavOverlay()) : (!this.menuOut || i > .3) && (this.enableScrolling(),
                    ...
                    this.$dragTarget.css({
                        ...
                        right: "",
                        left: 0
                    })) : this.menuOut && i >= -.3 || i > .5 ? (this.translateMenuX([0, a], "300"),
                    this.showSidenavOverlay(),
                    this.$dragTarget.css({
                        width: "50%",
                        right: "",
                        left: 0
                    })) : (!this.menuOut || i < -.3) && (this.enableScrolling(),
            ...
            value: function(t) {
                if ("touch" === t.gesture.pointerType) {
                    ...
                    n > 0 && (n = 0),
                    o < 0 && (o = 0),
                    "left" === this.options.edge ? (this.menuOut && e <= .3 || e < -.5 ? (0 !== n && this.translateMenuX([0, n], "300"),
                    this.showSidenavOverlay()) : (!this.menuOut || e > .3) && (this.enableScrolling(),
                    ...
                    this.$dragTarget.css({
                        ...
                        right: "",
                        left: 0
                    })) : this.menuOut && e >= -.3 || e > .5 ? (this.translateMenuX([0, o], "300"),
                    this.showSidenavOverlay(),
                    this.$dragTarget.css({
                        width: "50%",
                        right: "",
                        left: 0
                    })) : (!this.menuOut || e < -.3) && (this.enableScrolling(),
            ...
            value: function() {
                ...
                this.$element.on("click", function(i) {
                    ...
                    !0 === e.menuOut)
                        ...
                        !0 === e.options.showOverlay ? (e.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'),
                        e.$body.append(e.$sidenavOverlay)) : e.showCloseButton();
                        var n = [];
            ...
            value: function() {
                ...
                this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint && this.$menu.css("transform", "translateX(0)"),
            ...
            value: function(t) {
                ...
                this.$menu.hasClass("transform-fix-input") && this.$menu.removeClass("transform-fix-input"),
                this.hideSidenavOverlay()
            }
        }, {
            key: "show",
...
$(function() {
    $("#toggle").click(function() {
        $("#slide-out").hasClass("slim") ? ($("#slide-out").removeClass("slim"),
        $(".sv-slim-icon").removeClass("fa-angle-double-right").addClass("fa-angle-double-left")) : ($("#slide-out").addClass("slim"),
...
function(t) {
    var e, i = function() {
        function e(i, n) {
            ...
            this.$materialSelect = t('<input type="text" class="'.concat(this.options.BSinputText ? "browser-default custom-select multi-bs-select select-dropdown" : "select-dropdown", '" readonly="true" ').concat(this.$nativeSelect.is(":disabled") ? "disabled" : "", ' data-activates="select-options-').concat(this.uuid, '" value=""/>')),
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                this.options.destroy)
                    ...
                    this.options.language.active && this.$toggleAll && (this.options.language.pl && this.$toggleAll.find("label").text(this.options.language.pl.selectAll ? this.options.language.pl.selectAll : this.defaults.language.pl.selectAll),
                    ...
                    this.$materialSelect.hasClass("custom-select") && this.$materialSelect.hasClass("select-dropdown") && this.$materialSelect.css({
                        display: "inline-block",
                        width: "100%",
            ...
            value: function() {
                ...
                this.isMultiple)
                    this.$nativeSelect.find("option:selected:not(:disabled)").each(function(e, i) {
                        ...
                        t.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").eq(n).find(":checkbox").prop("checked", !0)
                    });
                else {
            ...
            value: function(e, i, n) {
                ...
                if (!o.hasClass("disabled") && !o.hasClass("optgroup")) {
                    ...
                    if (this.isMultiple) {
                        ...
                        a = this.isSearchable && r ? this._toggleSelectedValue(s - o.prevAll(".optgroup").length - 1) : this.isSearchable ? this._toggleSelectedValue(s - 1) : r ? this._toggleSelectedValue(s - o.prevAll(".optgroup").length) : this._toggleSelectedValue(s),
                        this._isToggleAllPresent() && this._updateToggleAllOption(),
                        this.$materialSelect.trigger("focus")
                    } else
                        this.$materialOptionsList.find("li").removeClass("active"),
                        o.toggleClass("active"),
                        this.$materialSelect.val(o.text().replace(/  +/g, " ").trim()),
            ...
            key: "_onHTMLClick",
            value: function(e) {
                t(e.target).closest("#select-options-".concat(this.uuid)).length || t(e.target).hasClass("mdb-select") || !t("#select-options-".concat(this.uuid)).hasClass("active") || (this.$materialSelect.trigger("close"),
                this.mainLabel.removeClass("active-check")),
                this.isSearchable && null !== this.$searchInput && this.$materialOptionsList.hasClass("active") && this.$materialOptionsList.find(".search-wrap input.search").focus()
            }
        }, {
            ...
            value: function(e) {
                ...
                this.$materialOptionsList.find("li:not(.optgroup):not(.disabled):not(.select-toggle-all)").each(function(e, n) {
                    ...
                    o && a.is(":checked") || !o && !a.is(":checked") || (i._isToggleAllPresent() && e++,
                    a.prop("checked", o),
            ...
            key: "_handleEnterKey",
            value: function(e) {
                this.$materialOptionsList.find("li.selected:not(.disabled)").trigger("click").addClass("active"),
        ...
        var h = !1
          ...
          , y = v.prototype = {
            ...
            open: function(n) {
                ...
                !1 !== n && (p.open = !0,
                h && t("body").css("overflow", "hidden").css("padding-right", "+=" + r()),
                ...
                i.on("click." + p.id + " focusin." + p.id, function(t) {
                    ...
                    var n = i.keyCode
                      , o = y.component.key[n]
                      , r = s(i, e);
                    27 == n ? y.close(!0) : r != y.$holder[0] || !o && 13 != n ? t.contains(y.$root[0], r) && 13 == n && (i.preventDefault(),
                    r.click()) : (i.preventDefault(),
                    o ? a._.trigger(y.component.key.go, y, [a._.trigger(o)]) : y.$root.find("." + m.highlighted).hasClass(m.disabled) || (y.set("select", y.component.item.highlight),
                    f.closeOnSelect && y.close(!0)))
                })),
                y.trigger("open"))
            },
            close: function(n) {
                return n && (f.editable ? e.focus() : (y.$holder.off("focus.toOpen").focus(),
                setTimeout(function() {
                ...
                p.open ? (p.open = !1,
                h && t("body").css("overflow", "").css("padding-right", "-=" + r()),
                i.off("." + p.id),
                y.trigger("close")) : y
            },
            clear: function(t) {
            ...
            set: function(e, i, n) {
                ...
                e) {
                    ...
                    s)
                        ...
                        "select" != o && "clear" != o || !f.updateInput || g.val("clear" == o ? "" : y.get(o, f.format)).trigger("change");
                    y.render()
                }
        ...
        function x() {
            y.$holder.on({
                ...
                "mousedown click": function(i) {
                    var n = s(i, e);
                    n != y.$holder[0] && (i.stopPropagation(),
                    "mousedown" != i.type || t(n).is("input, select, textarea, button, option") || (i.preventDefault(),
                    y.$holder.eq(0).focus()))
                }
                ...
                (n || o && !t.contains(y.$root[0], o)) && y.$holder.eq(0).focus(),
...
function(t) {
    ...
    o.prototype.measure = function(t, e) {
        return n.isInteger(e) ? e = this.now(t, e, {
            rel: e
        }) : e ? "string" == typeof e && (e = this.parse(t, e)) : e = "min" == t ? -1 / 0 : 1 / 0,
        e
    }
    ,
...
function() {
    ...
    function M(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"), p = r.find(".clockpicker-hours"), M = r.find(".clockpicker-minutes"), I = r.find(".clockpicker-am-pm-block"), A = "INPUT" === t.prop("tagName"), P = A ? t : t.find("input"), O = (P.prop("type"),
        n("label[for=" + P.attr("id") + "]")), _ = this;
        if (this.id = (o = ++v + "",
        (i = "cp") ? i + o : o),
        this.element = t,
        this.holder = c,
        ...
        n('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (e.twelvehour ? "4" : "2") + '">' + e.cleartext + "</button>").click(n.proxy(this.clearInput, this)).appendTo(this.footer),
        this.spanHours.click(n.proxy(this.toggleView, this, "hours")),
        this.spanMinutes.click(n.proxy(this.toggleView, this, "minutes")),
        P.on("focus.clockpicker click.clockpicker", m(n.proxy(this.show, this), 100));
        ...
        function N(t, i) {
            ...
            if (!i || !(f < b - w || f > b + w)) {
                ...
                a.off(h).on(h, function(t) {
                    ...
                    "hours" === _.currentView ? _.toggleView("minutes", C / 2) : e.autoclose && (_.minutesView.addClass("clockpicker-dial-out"),
                    setTimeout(function() {
                        _.done()
                    }, C / 2)),
                    l.prepend(z),
    ...
    M.prototype.show = function(t) {
        if (!this.isShown) {
            ...
            this.locate(),
            this.isShown = !0,
            a.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, m(function(t) {
                var i = n(t.target);
                0 === i.closest(e.popover.find(".picker__wrap")).length && 0 === i.closest(e.input).length && e.hide()
            }, 100)),
            a.on("keyup.clockpicker." + this.id, m(function(t) {
                27 === t.keyCode && e.hide()
            }, 100)),
    ...
    M.prototype.setHand = function(t, e, i, o) {
        var a, r, l = Math.atan2(t, -e), c = "hours" === this.currentView, u = Math.sqrt(t * t + e * e), d = this.options, h = c && u < (b + x) / 2, f = h ? x : b;
    ...
    M.prototype.clearInput = function() {
        this.input.val(""),
        this.hide(),
        this.options.afterDone && "function" == typeof this.options.afterDone && this.options.afterDone(this.input, null)
    }
    ,
...
function(t, e) {
    ...
    return function(t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, I, A, P, O, _, D, E, L, F, R, $, W, V, N, z, H, B, j, Y, q, X, U, Q, K, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
            x: 0,
            y: 0
        }, ct = {
            x: 0,
            ...
            Ft && (o.unbind(document, "mousemove", Rt),
        ...
        }, jt = {}, Yt = 0, qt = function(t) {
            jt[t] && (jt[t].raf && D(jt[t].raf),
            Yt--,
            delete jt[t])
        }, Xt = function(t) {
            jt[t] && qt(t),
        ...
        }, Zt = {}, Gt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {
            x: 0,
            y: 0
        }, le = 0, ce = {
            x: 0,
            ...
            if ($.isOldAndroid) {
                if (B && "mouseup" === t.type)
                    return;
                t.type.indexOf("touch") > -1 && (clearTimeout(B),
            ...
            var t, e, i = {
                ...
                calculateSwipeSpeed: function(n) {
                    oe.length > 1 ? (t = Mt() - V + 50,
                    e = oe[oe.length - 2][n]) : (t = Mt() - W,
                    e = ee[n]),
                ...
                panAnimLoop: function() {
                    return jt.zoomPan && (jt.zoomPan.raf = _(i.panAnimLoop),
                    i.now = Mt(),
        ...
        xt("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    O = !0) : t("mouse", "down", "move", "up"),
                    p = M + " " + T + " " + I,
                    f = S,
                    P && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
        ...
        var Fe, Re, $e, We, Ve, Ne, ze = function(e, i, n, s) {
            var l;
            Fe && clearTimeout(Fe),
            We = !0,
            $e = !0,
            ...
            var d = n ? r.hideAnimationDuration : r.showAnimationDuration
              , h = function() {
                ...
                a.bg.removeAttribute("style")) : (Tt(1),
            ...
            if (Be.length) {
                for (var t, e = 0; e < Be.length; e++)
                    (t = Be[e]).holder.index === t.index && qe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                Be = []
            }
        };
        xt("Controller", {
            publicMethods: {
                ...
                initController: function() {
                    ...
                    Ct("beforeChange", function(t) {
                        var e, i = r.preload, n = null === t || t >= 0, o = Math.min(i[0], Ne()), s = Math.min(i[1], Ne());
                        for (e = 1; (n ? s : o) >= e; e++)
                            a.lazyLoadItem(u + e);
                        for (e = 1; (n ? o : s) >= e; e++)
                            a.lazyLoadItem(u - e)
                ...
                setContent: function(t, e) {
                    ...
                    if (l) {
                        ...
                        !l.src || l.loadError || l.loaded)
                            ...
                            if (l.loadComplete = function(i) {
                                if (s) {
                                    if (t && t.index === e) {
                                        ...
                                        i.placeholder = null) : $.transform && (et || We) ? Be.push({
                                            item: i,
                                            baseDiv: c,
                                            img: i.img,
                                            index: e,
                            ...
                            l.loading || Xe(l),
                            a.allowProgressiveImg() && (!$e && $.transform ? Be.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: e,
        ...
        var Ze, Ge, Je = {}, ti = function(t, e, i) {
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(t) {
                    if (g <= a.currItem.fitRatio)
                        return r.modal && (!r.closeOnScroll || Yt || j ? t.preventDefault() : A && Math.abs(t.deltaY) > 2 && (c = !0,
                        a.close())),
                        !0;
...
function(t, e) {
    ...
    "use strict";
    return function(t, e) {
        var i, n, o, a, r, s, l, c, u, d, h, p, f, m, g, v, y, b, x = this, w = !1, k = !0, C = !0, S = {
            barsSize: {
                top: 44,
                bottom: "auto"
            },
...
function(t, e) {
    ...
    var w = function(t, e, i, n, o) {
        ...
        !function(t, e, i, n, o) {
            ...
            e && (p.dispatchEvent(c("ps-scroll-" + u)),
            e < 0 ? p.dispatchEvent(c("ps-scroll-" + d)) : e > 0 && p.dispatchEvent(c("ps-scroll-" + h)),
            n && l(t, u)),
      ...
      , C = function(t) {
        ...
        e.contains(t.scrollbarXRail) || (a(e, g.element.rail("x")).forEach(function(t) {
            return o(t)
        }),
        e.appendChild(t.scrollbarXRail)),
        e.contains(t.scrollbarYRail) || (a(e, g.element.rail("y")).forEach(function(t) {
            return o(t)
        }),
        ...
        p(e, t),
        t.scrollbarXActive ? e.classList.add(g.state.active("x")) : (e.classList.remove(g.state.active("x")),
        t.scrollbarXWidth = 0,
        t.scrollbarXLeft = 0,
        e.scrollLeft = 0),
        t.scrollbarYActive ? e.classList.add(g.state.active("y")) : (e.classList.remove(g.state.active("y")),
      ...
      , S = {
        ...
        keyboard: function(t) {
            ...
            t.event.bind(t.ownerDocument, "keydown", function(n) {
                if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (i() || o())) {
                    ...
                    t.settings.suppressScrollX && 0 !== r || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s,
                    e.scrollLeft += r,
                    C(t),
                    function(i, n) {
                        ...
                        if (0 === n) {
                            if (!t.scrollbarXActive)
                                return !1;
                            if (0 === a && i < 0 || a >= t.contentWidth - t.containerWidth && i > 0)
                                return !t.settings.wheelPropagation
                        }
                        return !0
        ...
        wheel: function(e) {
            function i(e, i, n) {
                if (!k.isWebKit && o.querySelector("select:focus"))
                    return !0;
                if (!o.contains(e))
                    return !1;
                for (var a = e; a && a !== o; ) {
                    if (a.classList.contains(g.element.consuming))
                        return !0;
                    var r = t(a);
                    if ([r.overflow, r.overflowX, r.overflowY].join("").match(/(scroll|auto)/)) {
                        var s = a.scrollHeight - a.clientHeight;
                        if (s > 0 && !(0 === a.scrollTop && n > 0 || a.scrollTop === s && n < 0))
                            return !0;
            ...
            function n(t) {
                ...
                if (!i(t.target, a, r)) {
                    var s = !1;
                    e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (r ? o.scrollTop -= r * e.settings.wheelSpeed : o.scrollTop += a * e.settings.wheelSpeed,
                    s = !0) : e.scrollbarXActive && !e.scrollbarYActive && (a ? o.scrollLeft += a * e.settings.wheelSpeed : o.scrollLeft -= r * e.settings.wheelSpeed,
                    s = !0) : (o.scrollTop -= r * e.settings.wheelSpeed,
                    ...
                    }(a, r)) && !t.ctrlKey && (t.stopPropagation(),
                    t.preventDefault())
                }
            }
            var o = e.element;
        ...
        touch: function(e) {
            function i(t, i) {
                ...
                } else if (a > r && (t < 0 && o === e.contentWidth - e.containerWidth || t > 0 && 0 === o))
                    return !0;
                return !0
            }
            function n(t, i) {
            ...
            function s(e, i, n) {
                ...
                for (var o = e; o && o !== u; ) {
                    ...
                    if ([a.overflow, a.overflowX, a.overflowY].join("").match(/(scroll|auto)/)) {
                        ...
                        if (r > 0 && !(0 === o.scrollTop && n > 0 || o.scrollTop === r && n < 0))
                            return !0;
            ...
            if (k.supportsTouch || k.supportsIePointer) {
                var u = e.element
                  ...
                  , p = {}
                  , f = null;
                k.supportsTouch ? (e.event.bind(u, "touchstart", r),
                e.event.bind(u, "touchmove", l),
                e.event.bind(u, "touchend", c)) : k.supportsIePointer && (window.PointerEvent ? (e.event.bind(u, "pointerdown", r),
                e.event.bind(u, "pointermove", l),
                e.event.bind(u, "pointerup", c)) : window.MSPointerEvent && (e.event.bind(u, "MSPointerDown", r),
      ...
      , M = function(n, o) {
        ...
        this.scrollbarYLeft = u(d.left)) : this.isScrollbarYUsingRight = !0,
...
function(t) {
    ...
    t.fn.materialChip = function(e) {
        ...
        this.getSingleChipHtml = function(t) {
            ...
            return t.image && (e += ' <img src="'.concat(t.image, '"> ')),
        ...
        var w = !!t.ResizeObserver && new t.ResizeObserver(function(t) {
          ...
          , S = function(t) {
            ...
            for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++)
                if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new C(t[o],e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)),
                void 0 !== r)
                    return r;
            return t
        };
        ...
        return _createClass(c, [{
            ...
            value: function() {
                ...
                this.$input.on("keyup", function(i) {
                    ...
                    13 === i.which && (e.$autocompleteWrap.children(":first").trigger("click"),
            ...
            key: "changeSVGcolors",
            value: function() {
                this.$input.hasClass("mdb-autocomplete") && (this.$input.on("click keyup", function(e) {
                    e.preventDefault(),
                    t(e.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", xColor)
                }),
                this.$input.on("blur", function(e) {
                    e.preventDefault(),
                    t(e.target).parent().find(".mdb-autocomplete-clear").find("svg").css("fill", xBlurColor)
                }))
            }
        }]),
        c
...
function(t) {
    t("body").on("shown.bs.modal", ".modal", function() {
        t(".modal-backdrop").length || ($modal_dialog = t(this).children(".modal-dialog"),
        $modal_dialog.hasClass("modal-side") && (t(this).addClass("modal-scrolling"),
        t("body").addClass("scrollable")),
        $modal_dialog.hasClass("modal-frame") && (t(this).addClass("modal-content-clickable"),
        t("body").addClass("scrollable")))
    }),
